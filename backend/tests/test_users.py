...
def test_list_users_by_role(client):
    ...
    client.post("/api/users/", json={"full_name": "C1", "email": "c1@q.com", "role": "creator", "password": DEFAULT_PASSWORD})
    client.post("/api/users/", json={"full_name": "A1", "email": "a1@q.com", "role": "approver_1", "password": DEFAULT_PASSWORD})
